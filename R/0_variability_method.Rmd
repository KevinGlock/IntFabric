---
title: "Gibt es gefälschte Interviews im ESS Round 1 Hungary"
subtitle: "Appendix"
abstract: "Inhalt: Gesamte Analyse der Hausarbeit"
author: "Kevin Glock"
...
```{r}
unique(int$INTNUM1) # 199 unique interviewer who started first contact
unique(int$INTNUM2) # 19
unique(int$INTNUM3) # 2
...
length(unique(mergeddata[,"INTNUM2"])) # 16 interviewers
length(unique(mergeddata[,"INTNUM3"])) # 1 interviewer
```
